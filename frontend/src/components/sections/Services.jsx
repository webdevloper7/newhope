    ...
    <section id="services" className="py-24 bg-gray-50/50">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h3 className="text-4xl lg:text-5xl font-black text-gray-900 tracking-tighter">Comprehensive Care for Every Pet</h3>
          <p className="text-lg text-gray-600">From routine checkups to advanced surgical procedures, we offer a full spectrum of veterinary services.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {services.map((service) => {
            ...
            return (
              <div 
                key={service.id} 
                className="group bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
              >
